...
from src.generate_UIDS import load_secret_key, make_kuin, remove_orphan_qr_files, write_distributable_workbook, write_qr_register, write_qr_stl_backup
...
def main() -> None:
    secret_key = load_secret_key(ROOT / "secret.key")
